    ...
    <header className="Header">
      <div className="HeaderInner">
        <Link href="/" className="HeaderLogoLink">
          ...
          <span className="HeaderLogoText">Red Hat AI AgentOps</span>
        </Link>
        <div className="HeaderDesktopActions">
          <SearchTrigger />
          <a className="HeaderLink" href="https://github.com/eformat/agentops-redhatskills-com" target="_blank" rel="noopener">
